...
const DesktopMockup: React.FC<DesktopMockupProps> = ({ lightImageUrl, darkImageUrl }) => {
  return (
    <>
      <div className="relative mx-auto border-gray-100 dark:border-gray-100 bg-gray-100 border-[8px] rounded-t-xl h-[172px] w-[301px] md:h-[294px] md:w-[512px]">
        <div className="rounded-lg overflow-hidden h-[156px] md:h-[278px] bg-white dark:bg-gray-800">
          {lightImageUrl && <img src={lightImageUrl} className="dark:hidden h-[156px] md:h-[278px] w-full rounded-xl" alt="Desktop Mockup Light" />}
          {darkImageUrl && <img src={darkImageUrl} className="hidden dark:block h-[156px] md:h-[278px] w-full rounded-lg" alt="Desktop Mockup Dark" />}
        </div>
      </div>
