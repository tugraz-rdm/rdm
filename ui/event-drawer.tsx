...
export const ButtonDrawer: React.FC<{
  ...
  return (
    ...
    >
      <div
        className="focus:ring-4-gray-700 -mt-2 mb-2 mr-2 rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:outline-none focus:ring-gray-700"
      ...
      >
        <div className="ml-5 flex gap-2">
          ...
          <Link
            href="/"
            className="items-left group flex w-full gap-x-3 lg:w-auto"
            onClick={toggleDrawer}
          >
            <h3 className="font-base -mr-1 -mt-2 ml-2 text-2xl tracking-wide text-white">
              RDM
            </h3>
            <h3 className="-mt-2 ml-1 text-2xl font-thin tracking-wide text-white">
