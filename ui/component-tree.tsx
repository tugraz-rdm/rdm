  ...
  return (
    <Boundary animateRerendering={false} labels={['Component Tree']}>
      <div className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="space-y-3 rounded-lg bg-gray-900 p-4">
              <div className="flex items-center justify-between gap-x-3">
                <div className="rounded-md bg-red-tu px-2 py-0.5 text-xs tabular-nums tracking-wider text-blue-50">
                  <CountUp
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-x-3 text-sm text-gray-400">
                <div className="rounded-md red-tu px-2 py-0.5 text-xs tracking-widest text-white/50">
                  {'</>'}
                </div>
        ...
        <div className="text-sm italic text-bg-red-tu">
