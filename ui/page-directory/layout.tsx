            ...
            <div className="flex items-center justify-between space-x-3 rounded-lg bg-gray-800 px-3 py-3 lg:px-5 lg:py-4">
              <div className="flex space-x-3">
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    name="search"
                    id="search"
                    className="block w-full rounded-full border-none bg-gray-600 pl-10 font-thin text-gray-200 focus:border-vercel-blue focus:ring-2 focus:ring-vercel-blue"
                    autoComplete="off"
                  />
                </div>
              </div>
              ...
              <div className="flex shrink-0 space-x-3">
                <div className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gray-600 text-white">
                  ...
                  <div className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full red-tu text-sm font-bold text-white">
                    0
                  </div>
                </div>
