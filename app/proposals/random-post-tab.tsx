export function getContentProposalAndTitleById(id: string) {
  const contentMap: Record<string, string> = {
    support:
      'Incorporate Research Data Management best practices within project proposals for efficient and responsible data handling. Ensure that your research project starts with a clear data strategy to optimize outcomes, meet funder requirements, and facilitate collaboration.',
