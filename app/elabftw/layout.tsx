    ...
    <div className="space-y-9">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Tab
          path="/elabftw"
          item={{
            text: 'OVERVIEW OF PERMISSIONS MANAGEMENT IN eLabFTW',
            slug: 'overview',
          }}
        />
        <Tab
          path="/elabftw"
          item={{ text: 'EXPORT OF ENTRIES', slug: 'entries' }}
        />
        <Tab
          path="/elabftw"
          item={{ text: 'TIP: LEAVING A TEAM/GROUP OR THE TOOLS', slug: 'tip' }}
        />
        <Tab
          path="/elabftw"
          item={{ text: 'BACKUP OPTIONS FOR USERS', slug: 'backup' }}
        />
